        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Overview',
                style: GoogleFonts.inter(fontSize: 13, color: Colors.white.withAlpha(190)),
              ),
            ],
          ),
          const Spacer(),
          ...
          return Expanded(
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                margin: EdgeInsets.only(right: p != controller.periods.last ? 8 : 0),
                padding: const EdgeInsets.symmetric(vertical: 10),
                decoration: BoxDecoration(
                  color: isSelected ? _primary : Colors.white,
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(color: isSelected ? _primary : _outlineVariant, width: 1.2),
          ...
          Obx(() {
            ...
            return Row(
              children: [
                ...
                Container(width: 1, height: 60, color: _outlineVariant.withAlpha(80), margin: const EdgeInsets.symmetric(horizontal: 16)),
                _SummaryKpi(
                  value: rate,
                  label: 'Response Rate',
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.auto_awesome_rounded, size: 20, color: _primary),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    text,
                    style: GoogleFonts.inter(fontSize: 12, color: _onSurface, height: 1.5),
                  ),
                ],
              ),
            ),
    ...
    return Obx(() {
      ...
      return Column(
        ...
        children: [
          ...
          Row(
            children: [
              _MiniStat(icon: Icons.call_rounded, label: 'Total Calls', value: '$total', color: _primary),
              const SizedBox(width: 10),
              _MiniStat(icon: Icons.phone_missed_rounded, label: 'Missed', value: '$missed', color: _error),
              const SizedBox(width: 10),
              _MiniStat(icon: Icons.forum_rounded, label: 'WhatsApp', value: '$whatsapp', color: const Color(0xFF25D366)),
              const SizedBox(width: 10),
              _MiniStat(icon: Icons.send_rounded, label: 'Replies', value: '$auto', color: _secondary),
            ],
          ),
        ],
      );
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                value,
                style: GoogleFonts.manrope(fontSize: 22, fontWeight: FontWeight.w800, color: _onSurface, height: 1),
              ),
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text(pct, style: GoogleFonts.manrope(fontSize: 13, fontWeight: FontWeight.w800, color: category.color)),
          ],
        ),
        const SizedBox(height: 4),
        Text(category.subtitle, style: GoogleFonts.inter(fontSize: 11, color: _onSurfaceVariant)),
        const SizedBox(height: 6),
        Stack(
          children: [
            Container(
              height: 8,
              decoration: BoxDecoration(color: _outlineVariant.withAlpha(80), borderRadius: BorderRadius.circular(6)),
            ),
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(value, style: GoogleFonts.manrope(fontSize: 16, fontWeight: FontWeight.w800, color: _onSurface, height: 1)),
            Text(label, style: GoogleFonts.inter(fontSize: 9, color: _onSurfaceVariant), textAlign: TextAlign.center),
          ],
        ),
      ),
    );
