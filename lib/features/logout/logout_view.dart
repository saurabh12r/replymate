...
///
/// Full-screen pushed view (not a dialog).
/// Comes from: Settings or User Profile
///
/// Design (from Stitch):
///  - Gradient header: "Settings · Manage your account and preferences"
///  - Profile card: Alex Johnson · alex.j@replymate.ai + avatar
///  - Logout section card: warning icon + "Are you sure?" titel + description
///  - Cancel (outlined) + Confirm Logout (red gradient) buttons
class LogoutView extends GetView<LogoutController> {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(email, style: GoogleFonts.inter(fontSize: 12, color: _onSurfaceVariant)),
                ],
              ),
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('Active', style: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w700, color: _secondary)),
                ],
              ),
            ),
          ],
          ...
          Container(
            ...
            child: Center(
              child: Container(
                ...
                child: const Icon(Icons.logout_rounded, size: 26, color: _error),
              ),
            ),
          ),
          const SizedBox(height: 20),
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(
                  'Logout',
                  style: GoogleFonts.manrope(fontSize: 12, fontWeight: FontWeight.w800, color: _error, letterSpacing: 0.5),
                ),
              ),
            ],
          ),
      ...
      return Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(item.$2, style: GoogleFonts.inter(fontSize: 12, color: _onSurfaceVariant)),
            ),
          ],
        ),
      );
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: loading
                    ? []
                    : [BoxShadow(color: _error.withAlpha(60), blurRadius: 14, offset: const Offset(0, 4))],
              ),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.arrow_back_rounded, color: _onSurface.withAlpha(180), size: 18),
                  const SizedBox(width: 8),
                  Text(
                    'Cancel, go back',
                    style: GoogleFonts.manrope(fontSize: 15, fontWeight: FontWeight.w700, color: _onSurface),
                  ),
                ],
              ),
            ),
  ...
  Widget _buildFooterNote() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Icon(Icons.shield_outlined, size: 14, color: _onSurfaceVariant.withAlpha(120)),
        const SizedBox(width: 6),
        Text(
          'Your data is safe — nothing will be deleted',
          style: GoogleFonts.inter(fontSize: 11, color: _onSurfaceVariant.withAlpha(160)),
        ),
      ],
    );
  }
