...
class SmsConfigView extends GetView<SmsConfigController> {
    ...
    return Obx(() => Container(
          ...
          decoration: BoxDecoration(
            gradient: autoReplyEnabled.value
                ? LinearGradient(
                    colors: [_primary.withAlpha(20), _primaryContainer.withAlpha(10)],
                  )
                : null,
            color: autoReplyEnabled.value ? null : Colors.white,
            borderRadius: BorderRadius.circular(18),
            border: Border.all(
              color: autoReplyEnabled.value ? _primary.withAlpha(80) : _outlineVariant,
              width: 1.2,
            ),
          ),
          child: Row(
      ...
      child: Column(
        children: [
          _ToggleRow(
            ...
            iconColor: _primary,
            title: 'Reply on Call',
            subtitle: 'Auto-reply when you receive a call',
          ...
          _ToggleRow(
            ...
            subtitle: 'Auto-reply on WhatsApp calls too',
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.schedule_rounded, size: 20, color: _secondary),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
          ...
          child: Column(
            children: [
              TextField(
                ...
                maxLines: 4,
                maxLength: 160,
                style: GoogleFonts.inter(fontSize: 14, color: _onSurface, height: 1.5),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border(
                    top: BorderSide(color: _outlineVariant.withAlpha(100), width: 1),
                  ),
                ),
                child: Row(
        ...
        return Padding(
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.format_quote_rounded, size: 16, color: _primary),
                  ...
                  const Icon(Icons.arrow_forward_ios_rounded, size: 12, color: _onSurfaceVariant),
                ],
              ),
            ),
          ),
  ...
  Widget _buildSaveButton() {
    return Obx(() {
      final canSave = controller.defaultReplyMessage.value.trim().isNotEmpty &&
