  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (controller.messages.isEmpty) {
          return Center(
            child: Column(
              ...
              children: [
                Icon(Icons.schedule_rounded, size: 80, color: theme.colorScheme.primary.withAlpha(50)),
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final dateStr = DateFormat('MMM d, yyyy - h:mm a').format(msg.scheduledTime);
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          dateStr,
                          style: GoogleFonts.inter(fontSize: 13, color: theme.colorScheme.secondary, fontWeight: FontWeight.w600),
                        ),
                      ],
                    ),
                  ],
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text('New Schedule', style: GoogleFonts.manrope(fontWeight: FontWeight.w700)),
      ),
    );
  }
}
