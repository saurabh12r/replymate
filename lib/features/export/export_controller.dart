...
class ExportController extends GetxController {
  ...
  final List<Map<String, dynamic>> formats = [
    {'label': 'PDF', 'icon': Icons.picture_as_pdf_rounded, 'desc': 'Best for sharing & printing'},
    {'label': 'CSV', 'icon': Icons.table_chart_rounded, 'desc': 'Raw data for spreadsheets'},
    {'label': 'Excel', 'icon': Icons.grid_on_rounded, 'desc': 'Rich formatting with charts'},
  ];
