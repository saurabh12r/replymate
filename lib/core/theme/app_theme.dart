  ...
  static ThemeData get dark {
    return ThemeData(
      ...
      textTheme: GoogleFonts.manropeTextTheme(ThemeData.dark().textTheme).copyWith(
        bodyMedium: GoogleFonts.inter(fontSize: 14, color: const Color(0xFFE5E7EB)),
        bodySmall: GoogleFonts.inter(fontSize: 12, color: const Color(0xFF9CA3AF)),
        labelMedium: GoogleFonts.inter(fontSize: 12, color: const Color(0xFFE5E7EB)),
        labelSmall: GoogleFonts.inter(fontSize: 11, color: const Color(0xFFE5E7EB)),
      ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(14),
          borderSide: const BorderSide(color: Color(0xFF3B82F6), width: 1.4), // primary
        ),
