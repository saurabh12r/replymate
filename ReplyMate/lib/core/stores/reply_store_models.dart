...
class ReplyStore {
  ...
  static ReplyStore fromJson(Map<String, dynamic> m) {
    ...
    if (legacyOut != null && legacyOut.isNotEmpty) {
      eventMap.putIfAbsent(
        ReplyStoreEventKeys.outgoingAnswered,
        () => legacyOut,
      );
      eventMap.putIfAbsent(
        ReplyStoreEventKeys.outgoingUnanswered,
        () => legacyOut,
      );
    }
    ...
    return ReplyStore(
      ...
      replyOutgoingAnswered:
          m['replyOutgoingAnswered'] == true ||
          (m['replyOutgoingAnswered'] == null && legacyOutToggle),
      replyOutgoingUnanswered:
          m['replyOutgoingUnanswered'] == true ||
          (m['replyOutgoingUnanswered'] == null && legacyOutToggle),
  ...
  ReplyStore copyWith({
    ...
    return ReplyStore(
      id: id ?? this.id,
      name: name ?? this.name,
      subscriptionId: clearSubscriptionId == true
          ? null
      ...
      replyOutgoingAnswered:
          replyOutgoingAnswered ?? this.replyOutgoingAnswered,
      replyOutgoingUnanswered:
          replyOutgoingUnanswered ?? this.replyOutgoingUnanswered,
...
ReplyStore? findStoreForSubscription(
  List<ReplyStore> stores,
  int subscriptionId,
) {
