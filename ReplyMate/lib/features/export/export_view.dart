...
class ExportView extends GetView<ExportController> {
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                margin: EdgeInsets.only(
                  right: label != controller.formats.last['label'] ? 10 : 0,
                ),
  ...
  Widget _divider() =>
      Divider(height: 1, indent: 56, color: _outlineVariant.withAlpha(80));
  ...
  Widget _buildGenerateButton() {
    return Obx(() {
      ...
      Color startColor = exporting
          ? Colors.grey.shade400
          : (success ? _secondary : _primary);
      Color endColor = exporting
          ? Colors.grey.shade300
          : (success ? const Color(0xFF2E7D32) : _primaryContainer);
