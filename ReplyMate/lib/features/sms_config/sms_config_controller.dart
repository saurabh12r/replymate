...
class SmsConfigController extends GetxController {
  ...
  Future<void> _loadConfig() async {
    ...
    try {
      ...
      replyOnRejectedCall.value =
          config['replyOnRejectedCall'] as bool? ?? false;
      replyOnOutgoingAnswered.value =
          config['replyOnOutgoingAnswered'] as bool? ?? false;
      replyOnOutgoingUnanswered.value =
          config['replyOnOutgoingUnanswered'] as bool? ?? false;
